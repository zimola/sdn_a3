...
class SimpleSwitch13(app_manager.RyuApp):
        ...
        if result:
           ...
           if src_sw != dst_sw:
              if dst_sw:
                ...
                print("PATH - Shortest Forwarding")
                print path
                ...
                if port:
                    ...
                    nextsw=path[sw_pos_in_path+1]
                    edge_attrib=nx.get_edge_attributes(self.net,'weight') 
                    port_out_2=edge_attrib[(datapath.id,nextsw)]['port'] 
                
                    self.send_group_mod(datapath, 2, in_port, in_port, port, port_out_2)
    ...
    def _packet_in_handler(self, ev):
        ...
        if isinstance(ip_pkt, ipv4.ipv4):
            ...
            if len(pkt.get_protocols(ethernet.ethernet)):
                ...
                print("packet in - shortest forwrding")
    ...
    def send_group_mod(self,datapath,group_id,watch_port1,out_port1,watch_port2,out_port2):
        ...
        weight = 0
        buckets = [ofp_parser.OFPBucket(weight, watch_port1, ofp.OFPG_ANY,actions1),
                   ofp_parser.OFPBucket(weight,watch_port2, ofp.OFPG_ANY,actions2)]
